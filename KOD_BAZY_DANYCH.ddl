...
CREATE TABLE bodyinmodel (
    carmodel_modelid NUMBER(6) NOT NULL,
    carbody_bodyid   NUMBER(6) NOT NULL
);
...
CREATE TABLE car (
    ...
    instytution_instid           NUMBER(6),
    dateofproduction             DATE NOT NULL,
    engine_engineid              NUMBER(6) NOT NULL,
    modelcolors_carmodel_modelid NUMBER(6) NOT NULL,
    modelcolors_colour_colourid  NUMBER(6) NOT NULL,
    gearboxtype_gearboxid        NUMBER(6) NOT NULL
);

ALTER TABLE car ADD CONSTRAINT car_pk PRIMARY KEY ( carid );

CREATE TABLE carbody (
    bodyid      NUMBER(6) NOT NULL,
    bodytype    VARCHAR2(20) NOT NULL,
    doorsamount NUMBER(2) NOT NULL
);
...
CREATE TABLE carorder (
    ...
    orderstatus_orderstatusid NUMBER(6) NOT NULL,
    instytution_instid        NUMBER(6) NOT NULL,
    delivery_deliveryid       NUMBER(6) NOT NULL,
...
CREATE TABLE carorderdetails (
    orderrecordid    NUMBER(6) NOT NULL,
    quantity         NUMBER(2) NOT NULL,
    carorder_orderid NUMBER(6) NOT NULL,
    car_carid        NUMBER(6) NOT NULL
);
...
CREATE TABLE city (
    ...
    country_countryid NUMBER(6) NOT NULL,
...
CREATE TABLE country (
    countryid                   NUMBER(6) NOT NULL,
    country                     VARCHAR2(20) NOT NULL,
    toyotaregion_toyotaregionid NUMBER(6) NOT NULL
);
...
CREATE TABLE delivery (
    deliveryid            NUMBER(6) NOT NULL,
    carorder_orderid      NUMBER(6) NOT NULL,
    deliverytype_dtypeid  NUMBER(6) NOT NULL,
    partorder_partorderid NUMBER(6) NOT NULL,
    deliverydate          DATE
);
...
CREATE TABLE employee (
    ...
    surename               VARCHAR2(30) NOT NULL,
    jobposition_positionid NUMBER(6) NOT NULL,
    instytution_instid     NUMBER(6)
);
...
CREATE TABLE engine (
    engineid                 NUMBER(6) NOT NULL,
    engine_type_enginetypeid NUMBER(6) NOT NULL,
...
CREATE TABLE engine_type (
    enginetypeid NUMBER(6) NOT NULL,
...
CREATE TABLE gadgets (
    gadgetid   NUMBER(6) NOT NULL,
    gadgetname VARCHAR2(30) NOT NULL
);

ALTER TABLE gadgets ADD CONSTRAINT gadgets_pk PRIMARY KEY ( gadgetid );

ALTER TABLE gadgets ADD CONSTRAINT gadgets_gadgetname_un UNIQUE ( gadgetname );

CREATE TABLE gadgetslist (
    listrecord       NUMBER(6) NOT NULL,
    gadgets_gadgetid NUMBER(6) NOT NULL,
    car_carid        NUMBER(6) NOT NULL
);
...
CREATE TABLE instytution (
    instid                  NUMBER(6) NOT NULL,
    instytutiontype_itypeid NUMBER(6) NOT NULL,
    city_cityid             NUMBER(6) NOT NULL,
...
CREATE TABLE modelcolors (
    carmodel_modelid NUMBER(6) NOT NULL,
    colour_colourid  NUMBER(6) NOT NULL
);
...
CREATE TABLE orderstatus (
    orderstatusid NUMBER(6) NOT NULL,
...
CREATE TABLE part (
    ...
    instytution_instid NUMBER(6),
    parttype_ptypeid   NUMBER(6) NOT NULL,
    dateofproduction   DATE NOT NULL
);
...
CREATE TABLE partcategory (
    partcategoryid NUMBER(6) NOT NULL,
...
CREATE TABLE partorder (
    partorderid               NUMBER(6) NOT NULL,
    orderstatus_orderstatusid NUMBER(6),
    instytution_instid        NUMBER(6) NOT NULL,
    delivery_deliveryid       NUMBER(6) NOT NULL,
...
CREATE TABLE partorderdeatils (
    podid                 NUMBER(6) NOT NULL,
    quantity              NUMBER(2) NOT NULL,
    partorder_partorderid NUMBER(6) NOT NULL,
    part_partid           NUMBER(6) NOT NULL
);
...
CREATE TABLE parttype (
    ptypeid                     NUMBER(6) NOT NULL,
    parttype                    VARCHAR2(30) NOT NULL,
    partcategory_partcategoryid NUMBER(6) NOT NULL
);
...
CREATE TABLE toyotaregion (
    toyotaregionid NUMBER(6) NOT NULL,
